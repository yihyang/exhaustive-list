 ...
 */
function isExhaustiveList(list = [], options = {}) {
  ...
  if (options.isSorted === true && !checkIsSorted(list)) {
 ...
 * @return {Boolean}       result
 */
function checkIsValidList(list) {
...
function addErrors(errors, index, message) {
